...
#+OPTIONS: auto-id:t
#+HTML_HEAD_EXTRA: <meta name="description" content="ebeem’s Picom Configuration" />
#+HTML_HEAD_EXTRA: <meta property="og:title" content="ebeem’s Picom Configuration" />
#+HTML_HEAD_EXTRA: <meta property="og:description" content="Description of the Picom configuration of ebeem" />
...
The battle plan of the fork was to refactor it to make the code possible to maintain, so potential contributors won't be scared away when they take a look at the code.
