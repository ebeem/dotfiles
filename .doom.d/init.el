...
(doom! :input
      ...
      :tools
       ...
       (java +eclim +lsp +meghanada +tree-sitter)       ; the poster child for carpal tunnel syndrome
       ...
       (lua +lsp +moonscript +tree-sitter)              ; one-based indices? one-based indices
       (markdown +grip)                                 ; writing docs for people to ignore
       nim                                              ; python + lisp at the speed of c
       nix                                              ; I hereby declare "nix geht mehr!"
       ;;ocaml                                          ; an objective camel
       (org +present +brain +dragndrop +journal +jupyter +noter +roam2 +pretty)          ; organize your plain life in plain text
